...
\end{figure}
\begin{figure}
   {\small, \flushleft \shadebox{$\upgamma, g \desugarFwdS \upgamma'$}
      \begin{smathpar}
         \inferrule*
         {
            g_i = \bind{x_i}{\seq{c_i}}
            \\
            v_i = \exClosure{\upgamma}{g}{\seq{c_i}}
            \quad
            \forall i \le \length{g}
         }
         {
            \upgamma, g \desugarFwdS \set{\seq{\bind{x}{v}}}
         }
      \end{smathpar}}
