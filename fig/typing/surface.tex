\begin{figure}
   ...
   \begin{smathpar}
      ...
      {
         \Gamma \concat \Delta \vdash \seq{c_i}: \tyFun{A_i}{B_i}
         \quad
         (\forall i \numleq j)
      }
      {
         \Gamma \vdash \seqRange{\bind{x_1}{\seq{c_1}}}{\bind{x_j}{\seq{c_j}}}: \Delta
      }
   \end{smathpar}
   ...
   \begin{smathpar}
      \inferrule*[right={$\primOp: \tyFun{\tyProd{A}{A}}{B} \in \Gamma$}]
      {
         \Gamma \vdash s: A
         \\
         \Gamma \vdash s': A
      ...
      {
         \Gamma \vdash \exBinaryApp{s}{\oplus}{s'}: B
      }
      %
      \and
      %
      ...
      \inferrule*
      {
         \Gamma \vdash s: A
         \\
         \Gamma \vdash \seq{c}: \tyFun{A}{B}
      }
      {
         \Gamma \vdash \exMatch{s}{\seq{c}}: B
      }
      %
      \and
      %
