\begin{figure}
   ...
   \begin{smathpar}
      ...
      %
      \inferrule*[
         lab={\ruleName{$\evalSugS$-enum-base}}
      ]
      {
         \upgamma, s_1 \evalSugS v_1
         \\
         \upgamma, s_2 \evalSugS v_2
         \\
         v_1 > v_2
      }
      {
         \upgamma, \exListEnum{s_1}{s_2} \evalSugS \cNil
      }
      %
      \and
      %
      \inferrule*[
         lab={\ruleName{$\evalSugS$-enum-rec}}
      ]
      {
         \upgamma, s_1 \evalSugS v_1
         \\
         ...
         v_1 \le v_2
         \\
         \upgamma, \exListEnum{(1 + s_1)}{s_2} \evalSugS v
      }
      {
         \upgamma, \exListEnum{s_1}{s_2} \evalSugS \cCons(v_1, v)
      }
   \end{smathpar}}
