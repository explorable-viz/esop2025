\begin{figure}
   ...
   \begin{smathpar}
      ...
      {
         \upgamma, \exList{s}{l} \evalSugR{\exList{S}{S'}} \cCons(v, v_{next})
      }
      %
      \and
      %
      ...
      ]
      {
         ...
         \\
         v1, \seq{\clauseUncurried{p}{s}}' \matchFwdS \upgamma', s^{\dag}
         \\
         \upgamma \concat \upgamma', s^{\dag} v
      }
      {
         \upgamma, \exMatch{s}{\seq{\clauseUncurried{p}{s}}'} \evalSugS v
      }
   \end{smathpar}}
