\begin{figure}
   \begin{tikzpicture}
      \begin{scope}[name prefix = input-]
         \node[fill=yellow, label={below:{emissions:18.17}}] (1) at (0, 0) {};
         \node[fill=yellow, label={below:{emissions:22.13}}] (2) at  (3, 0) {};
         \node[fill=yellow, label={below:{emissions:37.14}}] (3) at  (6, 0) {};
         \node[fill=yellow, label={below:{emissions:61.27}}] (4) at (9, 0) {};
      \end{scope}
      ...
      \end{scope}
   \end{tikzpicture}
   \caption{Schematic of the dependence graph of moving average}
\end{figure}