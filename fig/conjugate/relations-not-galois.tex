...
\begin{figure}
   \begin{subfigure}{0.49\textwidth}
      \begin{tikzpicture}[scale=.75,
         ...
         \begin{scope}[blend mode=difference]
            \draw[rounded corners, fill=blue, fill opacity= 0.75] (-0.1, 1.1) rectangle (1.1, -2.1);
            \draw[rounded corners, fill=green, fill opacity=0.75] (-0.2, 3.2) rectangle (1.2, -0.1);
            \draw[rounded corners, fill=myblue, fill opacity = 0.75] (2.9, 2.1) rectangle (4.1, -1.1);
         \end{scope}
   ...
   \begin{subfigure}{0.49\textwidth}
      \begin{tikzpicture}[scale=.75,
         ...
         \begin{scope}[blend mode=difference]
            \filldraw[rounded corners, fill=blue, fill opacity=0.75] (2.9, 1.1) rectangle (4.1, -2.1);
            \filldraw[rounded corners, fill=green, fill opacity=0.75] (2.8, 3.2) rectangle (4.2, -0.1);
            \filldraw[rounded corners, fill=myblue, fill opacity=0.75] (-0.1, 2.1) rectangle (1.1, -1.1);
         \end{scope}
