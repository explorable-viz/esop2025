...
/* package statemonad-0.1.0.0 */
#ifndef VERSION_statemonad
#define VERSION_statemonad "0.1.0.0"
#endif /* VERSION_statemonad */
#ifndef MIN_VERSION_statemonad
#define MIN_VERSION_statemonad(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_statemonad */
...
#define CURRENT_COMPONENT_ID "statemonad-0.1.0.0-inplace-statemonad"
