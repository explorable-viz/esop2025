...
source $PYENV/bin/activate
   ...
   python3 $PYTHONSCRIPT -t expensive -b bwd -d fig/performance/expensive-bwd > null
   python3 $PYTHONSCRIPT -t expensive -b fwd -d fig/performance/expensive-fwd > null
deactivate
