...
connection for ``cooperating inputs'' given by $R^{-1} \relcomp R$. We show how this can be used to relate
elements of a time series to elements of another time series when both are being consumed by a
