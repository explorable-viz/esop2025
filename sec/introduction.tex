...
leading to an easy implementation of the upper adjoint in terms of the lower. This naive implementation in the
worst case takes time proportional to the size of the graph, we also give a direct implementation of forward
slicing over a DDG and show that it too is on average much faster than the trace-based approach.
