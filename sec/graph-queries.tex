...
of these operators, which we write as $\demandsR$ and $\demandedByR$, and which also form a conjugate pair.
...
for'', $\sufficesR_R$ is a notion of sufficiency (what I am sufficient for). \todo{What about the other
operator? And we haven't introduced yet the idea of ancestors, etc.}
