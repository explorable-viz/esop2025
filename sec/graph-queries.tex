...
\todo{Need an intro. And rehash this section so it's more goal-oriented. Currently a bit unfocused.} 
\JBnote{In order to give a full account of cognacy queries, we first introduce some preliminaries -- 
Boolean algebras (\defref{conjugate:Boolean-algebra}) and the image and preimage
...
We then give algorithms for computing cognacy queries over a given graph (\secref{conjugate:dependence-graph-algos}).}
\todo{Example needed?}
