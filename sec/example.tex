...
We denote a selected by enclosing it in special delimiters like ((so)). In this
case, by selecting the sole output of the computation, our system discovers the
