...
For any constructor $c$ we write $\datatype{\Sigma}{c}$ to mean either the datatype that $c$ is a member of or
for the type signature $\tyForeign{\seq{A}}{D}$ of $c$. The meaning should be clear from the context.
