...
Write $\text{LHS} \eqif \text{RHS}$ to mean LHS is defined iff RHS is defined, in which case they are equal. This is used for stating properties like associativity and commutativity of partial operations.
