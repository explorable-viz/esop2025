...
dependence graph for a particular program, vertices $\alpha, \beta \in V$ are addresses
associated to values
(either supplied to the program as inputs or produced during evaluation) and edges $(\alpha, \beta) \in E$
indicate that, in the evaluation of the program, the value associated to $\beta$ \textit{depends on}
on the value associated to $\alpha$. Such values may be sub-terms of a larger value. This diverges somewhat from traditional approaches to dynamic
