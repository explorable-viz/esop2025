...
$\dom{G}$ and $\dom{G'}$ are disjoint (. We make use of this judgement in the rules \ruleName{$\evalS$-record}
for $\exRec{\seq{\bind{x}{e}}}$, \ruleName{$\evalS$-constr} for $c(\seq{e})$, and
...
we support mutual recursion. \figref{core:eval} also defines the auxiliary relation $\gamma, \rho, V
