...
\todo{Delete -- too short to be useful, and the programs don't convey anything interesting that shouldn't have
already been conveyed by earlier examples. Also both dictionaries and matrices have to be part of the core
language if we are to mention them at all, since we don't express them via desugaring.}
...
some of these features; for more complex examples, we refer the reader to the listings in
\apdxsecref{apdx:evaluation-src-code}.
