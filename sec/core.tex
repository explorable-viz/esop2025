...
convenience, we write $\inStar{V}{\alpha}$ as shorthand for the star graph $(\set{\alpha} \disjointUnion V, V
\times \set{\alpha})$ indicating that vertex $\alpha$ depends on all vertices in $V$.
