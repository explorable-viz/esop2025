...
evaluation step depends on \todo{Not quite, application is actually where we discard the ambient inputs and
instead start a new active function context}. Here, we compute the closure
