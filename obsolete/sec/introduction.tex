...
gap, presenting a graph-based framework which can be applied in multiple settings, and a
...
we present the semantics of the language before the introduction of the graph-related
