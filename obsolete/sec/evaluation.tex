...
interactive applcations like the linked inputs and related outputs queries discussed in \secref{overview}. We
have already established in \secref{graph} that slicing in the graph setting is much simplified
