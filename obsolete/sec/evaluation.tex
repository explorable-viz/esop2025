...
\begin{itemize}
    \item RQ1: How much does slicing performance improve in the graph approach?
...
\subsection{RQ1: How much does slicing performance improve in the graph approach?}
...
interactive applcations like the linked inputs and related outputs queries discussed in \secref{introduction}.
We have already established in \secref{graph} that slicing in the graph setting is much simplified
...
In both the trace-based and grap approaches, we construct an auxiliary data
...
In contrast, the graph evaluation approach works by annotating values with
...
We can see that whilst the graph slicing paradigm can improve the performance
