...
4, and show how the presented semantics leads to interesting dependency relationships.
...
using the De Morgan dual. We will streamline this section to make this clear.
...
our approach. We also show how this new flavour of brushing and linking can be understood as formally dual to
the traditional one. We will make sure to emphasise these as novel contributions of our approach and will
improve the contextualisation of our work with respect to these in the Introduction and in Related Work.
...
- Emphasise primary motivation as performance-related and de-emphasise developer and end-user benefits
  (Reviewer B, C2)
